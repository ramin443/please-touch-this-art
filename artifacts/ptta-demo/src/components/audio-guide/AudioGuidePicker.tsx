...
export function AudioGuidePicker({ onSelect }: Props) {
  return (
    <div className="ptta-root min-h-[100dvh] bg-page text-ink">
      <Header showBack backHref="/demo-hub" tag="AUDIO GUIDE · 03" />

      <div className="mx-auto w-full max-w-[440px] px-5 pt-6 pb-10">
        <SectionLabel label="Audio Guide" tag="Module · 03" />
        ...
        <div className="text-center mb-6">
          <h1
            ...
            style={titleStyle}
          >
            — Pick a piece to listen.
          </h1>
        </div>

        {/* Paintings — 2-col grid */}
    ...
    <button
      ...
      aria-label={
        disabled
          ...
          : `Listen to ${model.title} by ${model.artist}`
      }
      className={cn(
